    ...
    <div className="min-h-screen w-[90%] mx-auto bg-white">
      ...
      <main className="mx-auto  px-4 py-8">
        ...
        <section id="s1" className="scroll-mt-24">
          ...
          <p className="mt-3 text-gray-800">
            These GTS have been announced and fully accepted following publication of the same on the WattMatrix corporate website (https://www.wattmatrix.com/, section Download), from where they can be freely accessed and consulted. Specific wording in reference to these GTS is to be found at the foot of each Purchase Order sent by WattMatrix, and acceptance of the same by compliant Suppliers is required at the end of the registration procedure for the WattMatrix Supplier Portal.
          </p>
        </section>
